...
/// <summary>
/// Evaluates ternary expressions using a specialized approach.
/// </summary>
internal class TernaryExpressionEvaluator
{
    private readonly ExpressionEvaluator _expressionEvaluator;

    // Regex for detecting potential ternary expressions
    ...
    public object? EvaluateTernary(string expression, object? parameter, DollarSignOptions options)
    {
        ...
        try
        {
            ...
            bool conditionValue = ConvertToBoolean(conditionResult);
    ...
    /// <summary>
    /// Converts a result to boolean for condition evaluation.
    /// </summary>
    private bool ConvertToBoolean(object? value)
    {
        ...
        {
            throw new DollarSignEngineException($"Could not convert condition result to boolean: {ex.Message}", ex);
        }
    }
